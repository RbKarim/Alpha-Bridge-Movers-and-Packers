...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="row featurette d-flex justify-content-center align-items-center my-4">
        ...
        <div class="col-md-6 order-md-2">
            <h2 class="featurette-heading">Commercial Service</h2>
            <p class="lead">
                Minimize downtime and stress with our team of expert office movers who understand your needs and will deliver a successful, seamless commercial relocation service.
            </p>
        </div>
        <div class="col-md-5 order-md-1">
            <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="600" height="600" src="img\commercial.jpg" alt="">
        </div>
        <div class="col-md-1">
        </div>
    </div>
