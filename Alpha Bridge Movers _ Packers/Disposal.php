...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="row featurette d-flex justify-content-center align-items-center my-4">
        ...
        <div class="col-md-6 order-md-1">
            <h2 class="featurette-heading">Disposal Service</h2>
            <p class="lead">
                We do our best to provide professional waste removal at the lowest possible cost. We value our customers and will continue our efforts to ensure you receive excellent service. In this effort our new trucks are out on route. They are only picking up recycling!!
               Only the Big 4 should be placed in your recycling bin.
        ...
        <div class="col-md-5 order-md-2">
            <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="600" height="600" src="img\disposal.jpg" alt="">
        </div>
        <div class="col-md-1">
        </div>
    </div>
