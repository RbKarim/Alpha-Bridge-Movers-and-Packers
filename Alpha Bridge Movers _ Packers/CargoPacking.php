...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="row featurette d-flex justify-content-center align-items-center my-4">
        ...
        <div class="col-md-6 order-md-1">
            <h2 class="featurette-heading">Cargo Packiging Service</h2>
            <p class="lead">
                We specialize in providing the most convenient, reliable, timely and accurate customs clearance and freight forwarding facilities to our valued clients.
                To ensure that, we instigate a full proof process in carrying out our services throughout (from pre arranged release to speed delivery of goods) so that there is no delay or hindrance at any step at all.
                The terms like unique and trustworthy appear out to be most appropriate if one strives to look for the words to illustrate the quality of Customs Clearing and Freight Forwarding Services offered by us.

                Our quintessentially qualified team members are capable of undertaking the customs clearance and freight forwarding procedure for you with ease while appropriately utilizing individual expertise.</p>
        </div>
        <div class="col-md-5 order-md-2">
            <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="600" height="600" src="img\cargopack.jpg" alt="">
        </div>
        <div class="col-md-1">
        </div>
    </div>
