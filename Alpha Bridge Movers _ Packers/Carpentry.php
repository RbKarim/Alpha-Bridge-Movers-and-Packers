...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="row featurette d-flex justify-content-center align-items-center my-4">
        ...
        <div class="col-md-6 order-md-2">
            <h2 class="featurette-heading">Carpentry Service</h2>
            <p class="lead">
                Mover and Packers brings you the best carpenters near you at your home. All professionals are background verified. They go through a number of security checks before they are brought on board.
                You get a doorstep repair within 180 minutes from the best carpentry services around you. You just need to place an order and wait for the professional at your door step.
            </p>
        </div>
        <div class="col-md-5 order-md-1">
            <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="600" height="600" src="img\carpentry.jpg" alt="">
        </div>
        <div class="col-md-1">
        </div>
    </div>
