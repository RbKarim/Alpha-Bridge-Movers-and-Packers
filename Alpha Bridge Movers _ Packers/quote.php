...
<body class="d-flex flex-column min-vh-100">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="#">Cargo packing staff</a></li>
                            <li><a class="dropdown-item" href="#">Residential packaging and shifting service</a></li>
                            <li><a class="dropdown-item" href="#">Commercial packaging and shifting service</a></li>
                            <li><a class="dropdown-item" href="#">Disposal service</a></li>
                            <li><a class="dropdown-item" href="#">Carpentry service</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-3 ">
                <!--Qoute form left-->
                <form method="post" id="Aform" class="input_form2">
                    <label for="Name" class="form-label">Name</label>
                    <input type="text" class="form-control" id="Name" placeholder="Mr.X" name="name"><br>
                    <label for="Email" class="form-label">Email address</label>
                    <input type="email" class="form-control" id="Email" placeholder="name@mail.com" name="email"><br>
                    <label for="ploc" class="form-label">Present Location</label>
                    <input type="text" class="form-control" id="ploc" placeholder=" " name="p_loc"><br>
                    <label for="pacdate" class="form-label">Packing Date</label>
                    <input type="date" class="form-control" id="pacdate" name="p_date"><br>
                    <label for="" class="form-label">Services</label>
                    <select name="service" class="form-select" aria-label="Default select example">
                        <option value="1">Cargo packing staff</option>
                        <option value="2">Residential packaging and shifting service</option>
                        <option value="3">Commercial packaging and shifting service</option>
                        <option value="4">Disposal service</option>
                        <option value="5">Carpentry service</option>
            ...
            <div class="col-md-3 ">
                ...
                <form method="post" id="Aform" class="input_form2">
                    ...
                    <input type="number" class="form-control" id="mblno" placeholder="01XXXXXXXXX" name="mobile"><br>
                    ...
                    <input type="text" class="form-control" id="Dloc" placeholder=" " name="d_loc"><br>
                    <label for="Ddate" class="form-label">Delivery Date</label>
                    <input type="date" class="form-control" id="Ddate" placeholder=" " name="d_date">
        ...
        <div class="row">
            <div class="col-md-4 mx-auto">
                <button type="submit" class="submit_btn" name="form_submit">Send us</button>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-5 footertext ">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="quote.php" class="nav-link p-0 text-muted">Get Quote</a></li>
